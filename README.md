...
1. Auf dem Druckserver `SimplePrint-Server-Setup-0.2.6.exe` installieren.
2. `SimplePrint Server` öffnen und die gewünschten lokalen Drucker freigeben.
3. Auf jedem Windows-10/11-Client `SimplePrint-Client-Setup-0.2.6.exe` installieren.
