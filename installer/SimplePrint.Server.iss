...
WizardStyle=modern
SetupIconFile={#RootDir}\assets\app-0.2.13.ico
UninstallDisplayIcon={app}\Server\assets\app-0.2.13.ico
...
Source: "{#RootDir}\assets\app-0.2.13.ico"; DestDir: "{app}\Server\assets"; DestName: "app-0.2.13.ico"; Flags: ignoreversion
...
[Icons]
Name: "{group}\SimplePrint Server"; Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; IconFilename: "{app}\Server\assets\app-0.2.13.ico"
Name: "{group}\SimplePrint Server deinstallieren"; Filename: "{uninstallexe}"; IconFilename: "{app}\Server\assets\app-0.2.13.ico"
Name: "{commondesktop}\SimplePrint Server"; Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; IconFilename: "{app}\Server\assets\app-0.2.13.ico"; Tasks: desktopicon
