...
UninstallDisplayIcon={app}\Server\assets\app-0.2.5.ico
...
Source: "{#RootDir}\assets\app-0.2.5.ico"; DestDir: "{app}\Server\assets"; DestName: "app-0.2.5.ico"; Flags: ignoreversion
...
[Icons]
Name: "{group}\SimplePrint Server"; Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; IconFilename: "{app}\Server\assets\app-0.2.5.ico"
Name: "{group}\SimplePrint Server deinstallieren"; Filename: "{uninstallexe}"; IconFilename: "{app}\Server\assets\app-0.2.5.ico"
Name: "{commondesktop}\SimplePrint Server"; Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; IconFilename: "{app}\Server\assets\app-0.2.5.ico"; Tasks: desktopicon
