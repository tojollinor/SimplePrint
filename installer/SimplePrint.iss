...
UninstallDisplayIcon={app}\Client\Gui\SimplePrint.Client.Gui.exe
...
[Icons]
Name: "{group}\SimplePrint Server"; Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; Components: server
Name: "{group}\SimplePrint Client"; Filename: "{app}\Client\Gui\SimplePrint.Client.Gui.exe"; Components: client
Name: "{commondesktop}\SimplePrint Server"; Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; Components: server; Tasks: desktopicon
Name: "{commondesktop}\SimplePrint Client"; Filename: "{app}\Client\Gui\SimplePrint.Client.Gui.exe"; Components: client; Tasks: desktopicon
...
Filename: "{app}\Server\Gui\SimplePrint.Server.Gui.exe"; Description: "SimplePrint Server öffnen"; Flags: nowait postinstall skipifsilent; Components: server
Filename: "{app}\Client\Gui\SimplePrint.Client.Gui.exe"; Description: "SimplePrint Client öffnen"; Flags: nowait postinstall skipifsilent; Components: client
