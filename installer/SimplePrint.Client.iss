...
WizardStyle=modern
SetupIconFile={#RootDir}\assets\app-0.2.8.ico
UninstallDisplayIcon={app}\Client\assets\app-0.2.8.ico
...
Source: "{#RootDir}\assets\app-0.2.8.ico"; DestDir: "{app}\Client\assets"; DestName: "app-0.2.8.ico"; Flags: ignoreversion
...
[Icons]
Name: "{group}\SimplePrint Client"; Filename: "{app}\Client\Gui\SimplePrint.Client.Gui.exe"; IconFilename: "{app}\Client\assets\app-0.2.8.ico"
Name: "{group}\SimplePrint Client deinstallieren"; Filename: "{uninstallexe}"; IconFilename: "{app}\Client\assets\app-0.2.8.ico"
Name: "{commondesktop}\SimplePrint Client"; Filename: "{app}\Client\Gui\SimplePrint.Client.Gui.exe"; IconFilename: "{app}\Client\assets\app-0.2.8.ico"; Tasks: desktopicon
